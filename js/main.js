$(document).ready(function() {
	...
	$(pull).on("click", function(e){
	    ...
	    $(this).toggleClass('navigation_toggle_button--active');
	...
	$(window).resize(function(){
	    ...
	    if(w > 992) {
	        ...
	        pull.removeClass('navigation_toggle_button--active');
	    } else {
	...
	function fnstart(){	
		if ( $("#navigation_toggle").hasClass("navigation_toggle_button--active")  ) {
   			pull.toggleClass('navigation_toggle_button--active');
			menu.slideToggle();
		}
	};
